...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class ServicioEmail : IServicioEmail
    {
        ...
        {
            //esto lo configuramos en appsettings.Development.json
            ...
            var contenidoHtml = $@"Saludos, Este mensaje le llega porque usted ha solicitado un cambio de contraseña. Si esta solicitud no fue hecha por usted, puede ignorar este mensaje.
